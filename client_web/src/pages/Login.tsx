...
export default function LoginPage({ darkMode }: LoginPageProps) {
  ...
  return (
    <div className={`min-h-screen flex font-sans ${darkMode ? "bg-slate-950 text-white" : "bg-white text-slate-900"}`}>
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden min-h-screen shrink-0">
        <img
          src="https://images.unsplash.com/photo-1497015289639-546bb1ba0bc6?q=80&w=2044&auto=format&fit=crop"
          alt=""
        ...
        <div className="relative z-10 w-full min-h-screen flex flex-col items-center justify-center text-white p-12">
          ...
          <div className="max-w-md w-full flex flex-col items-center text-center">
            ...
            <p className="text-orange-100 text-lg xl:text-xl font-medium">
              Access your creative portfolio and workspace.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className={`w-full lg:w-1/2 flex flex-col min-h-screen ${darkMode ? "bg-slate-900" : "bg-white"}`}>
        ...
        <div className="flex-1 min-h-0 flex flex-col overflow-y-auto">
          <div className="min-h-full flex flex-col justify-center px-6 lg:px-10 xl:px-14 py-5 pb-24">
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className={`w-full pl-10 pr-10 py-3 rounded-xl border transition-all outline-none text-sm ${
                      errors.password ? "border-red-500" : darkMode ? "bg-slate-800 border-slate-700 focus:border-orange-500" : "bg-white border-slate-200 focus:border-orange-500"
                    }`}
